...
const util = (() => {
    ...
    const open = async (lang) => {
        ...
        if (lang === "GUJ") {
            ...
            document.getElementById('sonFatherName').innerHTML = 'સબ્બીરભાઈ ચોરવાડા';
            document.getElementById('daughterName').innerHTML = 'આફરીન સોરઠીયા';
            document.getElementById('daughterFatherName').innerHTML = 'હુસેનભાઈ સોરઠીયા';
